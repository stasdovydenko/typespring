...
function PostRequest(url, middleware) {
    ...
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function () {
            ...
            return router.post(url, groupMiddleware.concat(middleware), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var r, e_1;
